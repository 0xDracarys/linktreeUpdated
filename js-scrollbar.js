/*** JQUERY SCROLLBAR FILE ***/ ! function(a, b) {
	...
	e.prototype = {
		...
		init: function(b) {
			...
			if (c.mobile && h.ignoreMobile || c.overlay && h.ignoreOverlay || c.macosx && !c.webkit) return !1;
			if (k) f.css({
				height: "auto",
				...
				if (this.wrapper = k = a("<div>").addClass("scroll-wrapper").addClass(e.attr("class")).css("position", "absolute" == e.css("position") ? "absolute" : "relative").insertBefore(e).append(e), e.is("textarea") && (this.containerWrapper = f = a("<div>").insertBefore(e).append(e), k.addClass("scroll-textarea")), f.addClass("scroll-content").css({
						height: "auto",
						"margin-bottom": c.scroll.height * -1 + "px",
						"margin-right": c.scroll.width * -1 + "px",
						"max-height": ""
						...
						a.isFunction(h.onScroll) && h.onScroll.call(d, {
							...
							size: i.x.size,
							visible: i.x.visible
						}), i.x.isVisible && i.x.scroll.bar.css("left", e.scrollLeft() * i.x.kx + "px"), i.y.isVisible && i.y.scroll.bar.css("top", e.scrollTop() * i.y.kx + "px")
					}), k.on("scroll" + g, function() {}), h.disableBodyScroll) {
					var m = function(a) {
						j(a) ? i.y.isVisible && i.y.mousewheel(a) : i.x.isVisible && i.x.mousewheel(a)
					};
					k.on("MozMousePixelScroll" + g, m), k.on("mousewheel" + g, m), c.mobile && k.on("touchstart" + g, function(b) {
			...
			a.each(i, function(b, c) {
				var f = null,
					...
					n = function() {
						var a = e[l]();
						e[l](a + m), 1 == k && a + m >= o && (a = e[l]()), k == -1 && a + m <= o && (a = e[l]()), e[l]() == a && f && f()
					},
					o = 0;
				c.scroll || (c.scroll = d._getScroll(h["scroll" + b]).addClass("scroll-" + b), h.showArrows && c.scroll.addClass("scroll-element_arrows_visible"), c.mousewheel = function(a) {
					...
					return (f > 0 && o < g || f < 0 && o > 0) && (o += f, o < 0 && (o = 0), o > g && (o = g), d.scrollTo = d.scrollTo || {}, d.scrollTo[l] = o, setTimeout(function() {
						d.scrollTo && (e.stop().animate(d.scrollTo, 240, "linear", function() {
							o = e[l]()
						}), d.scrollTo = null)
					}, 1)), a.preventDefault(), !1
				}, c.scroll.on("MozMousePixelScroll" + g, c.mousewheel).on("mousewheel" + g, c.mousewheel).on("mouseenter" + g, function() {
					o = e[l]()
				}), c.scroll.find(".scroll-arrow, .scroll-element_track").on("mousedown" + g, function(g) {
					if (1 != g.which) return !0;
					k = 1;
					var i = {
							eventOffset: g["x" === b ? "pageX" : "pageY"],
							maxScrollValue: c.size - c.visible - c.offset,
							scrollbarOffset: c.scroll.bar.offset()["x" === b ? "left" : "top"],
							scrollbarSize: c.scroll.bar["x" === b ? "outerWidth" : "outerHeight"]()
						},
						j = 0,
						p = 0;
					return a(this).hasClass("scroll-arrow") ? (k = a(this).hasClass("scroll-arrow_more") ? 1 : -1, m = h.scrollStep * k, o = k > 0 ? i.maxScrollValue : 0) : (k = i.eventOffset > i.scrollbarOffset + i.scrollbarSize ? 1 : i.eventOffset < i.scrollbarOffset ? -1 : 0, m = Math.round(.75 * c.visible) * k, o = i.eventOffset - i.scrollbarOffset - (h.stepScrolling ? 1 == k ? i.scrollbarSize : 0 : Math.round(i.scrollbarSize / 2)), o = e[l]() + o / c.kx), d.scrollTo = d.scrollTo || {}, d.scrollTo[l] = h.stepScrolling ? e[l]() + m : o, h.stepScrolling && (f = function() {
						o = e[l](), clearInterval(p), clearTimeout(j), j = 0, p = 0
					}, j = setTimeout(function() {
						p = setInterval(n, 40)
					}, h.duration + 100)), setTimeout(function() {
						d.scrollTo && (e.animate(d.scrollTo, h.duration), d.scrollTo = null)
					}, 1), d._handleMouseDown(f, g)
				}), c.scroll.bar.on("mousedown" + g, function(f) {
					if (1 != f.which) return !0;
					var h = f["x" === b ? "pageX" : "pageY"],
						i = e[l]();
					return c.scroll.addClass("scroll-draggable"), a(document).on("mousemove" + g, function(a) {
						var d = parseInt((a["x" === b ? "pageX" : "pageY"] - h) / c.kx, 10);
						e[l](i + d)
